    ...
    <div className={`space-y-1 ${className}`}>
      ...
      <div className="flex gap-2 items-center">
        ...
        <input
          ...
          value={displayValue}
          onChange={(e) => onChange(e.target.value)}
          className="flex-1 w-full min-w-0 px-2 py-1.5 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-md text-xs font-mono text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary uppercase"
          placeholder="#000000"
          spellCheck={false}
        />
      </div>
