                                ...
                                {conditions.map((conditionRow, index) => (
                                    <div key={conditionRow.id} className="relative grid grid-cols-12 gap-2 items-start group">
                                        ...
                                        <div className="col-span-4 space-y-1">
                                            ...
                                            <select
                                                className="shadow w-full text-xs border-gray-300 dark:border-gray-600 rounded focus:border-primary focus:ring-primary focus:outline-none px-2 py-1.5 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
