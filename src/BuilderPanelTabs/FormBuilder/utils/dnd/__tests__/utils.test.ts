...
import { DateField, EmailField, Field, InputField, PhoneField } from '../../../../types';
...
describe('dnd/utils', () => {
  describe('createFieldFromType', () => {
    it('should generate unique IDs for each field', () => {
      ...
      const field2 = createFieldFromType(FieldType.TEXT, 'Name');
    ...
    it('should create a checkbox field with default options', () => {
      ...
      expect(field.name).toBe('preferences');
