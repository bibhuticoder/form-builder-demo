...
import { CalendarDaysIcon, ClockIcon, Cog6ToothIcon, QuestionMarkCircleIcon } from "@heroicons/react/24/outline"
...
export function AutomationSettings() {
  const { status, setStatus, settings, setSettings, setIsDirty } = useAutomationBuilderContext()
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="sm" className="gap-2 h-8 px-3 text-xs text-slate-600 dark:text-slate-200 dark:bg-slate-800 dark:border-slate-700 dark:hover:bg-slate-700 focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0 active:ring-0">
